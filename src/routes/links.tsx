                                                        ...
                                                        href: string;
                                                          external?: boolean;
                                                            ...
                                                            const primaryLinks: LinkItem[] = [
                                                              { label: "Surf School & Lessons", sub: "Book a session on the Atlantic", href: "/surf", icon: <Waves className="h-5 w-5" /> },
                                                                { label: "Hostel Reservation", sub: "Sleep steps from the break", href: "/hostel", icon: <BedDouble className="h-5 w-5" /> },
                                                                  { label: "Shop the Collection", sub: "Streetwear & essentials", href: "/shop", icon: <ShoppingBag className="h-5 w-5" /> },
                                                                  ];

                                                                  const socialLinks: LinkItem[] = [
                                                                    { label: "@area.clothing", sub: "Instagram", href: "https://instagram.com/area.clothing", external: true, icon: <Instagram className="h-5 w-5" /> },
                                                                      { label: "@areasurfschool", sub: "Instagram", href: "https://instagram.com/areasurfschool", external: true, icon: <Instagram className="h-5 w-5" /> },
                                                                        { label: "@areasurfhostel", sub: "Instagram", href: "https://instagram.com/areasurfhostel", external: true, icon: <Instagram className="h-5 w-5" /> },
                                                                          { label: "@area.clothing.shop", sub: "Facebook", href: "https://facebook.com/area.clothing.shop", external: true, icon: <Facebook className="h-5 w-5" /> },
                                                                          ];
                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                Surf school, hostel and homegrown clothing line on the Atlantic coast.
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                {/* Primary links */}
                                                                                                                                                                                                                                                                                                                        <div className="mt-10 w-full space-y-3">
                                                                                                                                                                                                                                                                                                                                  {primaryLinks.map((l) => <LinkRow key={l.label} item={l} />)}
                                                                                                                                                                                                                                                                                                                                          </div>
                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                          <div className="mt-10 w-full">
                                                                                                                                                                                                                                                                                                                                                                    <p className="mb-3 text-center text-[11px] font-bold uppercase tracking-[0.4em] text-accent">Follow us</p>
                                                                                                                                                                                                                                                                                                                                                                              <div className="space-y-3">
                                                                                                                                                                                                                                                                                                                                                                                          {socialLinks.map((l) => <LinkRow key={l.label} item={l} />)}
                                                                                                                                                                                                                                                                                                                                                                                                    </div>
                                                                                                                                                                                                                                                                                                                                                                                                            </div>
